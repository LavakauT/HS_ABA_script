...
dap=/RAID1/working/R425/lavakau/kmer/ArabidopsisDAPv1.meme

### motif files, upper folder path
get_folder_path=/RAID1/working/R425/lavakau/kmer
i_path=${get_folder_path}/sly_acr_dis
echo "RUNNING DIRECTORY: "${i_path}
echo "RUNNING MOTIFS: "${dap}
Rscript ${i_path}/kmer_sim_dap.R ${i_path} ${dap}
